...
<div class="services-breadcrumb">
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					...
					<?php
					$sql_tendanhmuc = mysqli_query($mysqli,"SELECT * FROM tbl_danhmuctin WHERE danhmuctin_id='$id_danhmuc'");
	...
	<div class="welcome py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<?php
				$sql_tendanhmuc1 = mysqli_query($mysqli,"SELECT * FROM tbl_danhmuctin WHERE danhmuctin_id='$id_danhmuc'");
				$row_danh1 = mysqli_fetch_array($sql_tendanhmuc1);
			?>
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3"><?php echo $row_danh['tendanhmuc'] ?></h3>
			<!-- //tittle heading -->
			<?php
				$sql_baiviet = mysqli_query($mysqli, "SELECT * FROM tbl_danhmuctin, tbl_baiviet WHERE tbl_danhmuctin.danhmuctin_id=tbl_baiviet.danhmuctin_id 
					AND tbl_danhmuctin.danhmuctin_id='$id_danhmuc'");
